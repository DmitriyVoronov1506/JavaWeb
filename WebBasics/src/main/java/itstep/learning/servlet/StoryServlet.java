...
public class StoryServlet extends HttpServlet {
    ...
    protected void doPut(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            transport.connect("smtp.gmail.com", "ftts15.voronov@gmail.com", "pdxbureyvlxzztgz");
            transport.sendMessage(message, InternetAddress.parse("dmitriy.voronov1506@gmail.com"));
            transport.close();
        }
